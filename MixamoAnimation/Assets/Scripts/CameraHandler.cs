...
namespace OK
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        private Vector3 _cameraTransfromPosition;
        ...
        private void HandleCameraCollisions(float delta)
        {
            ...
            if (Physics.SphereCast
                (_cameraPivotTransform.position, _cameraSphereRadius, direction, out hit, Mathf.Abs(_targetPosition), _ignoreLayers))
            {
            ...
            _cameraTransfromPosition.z = Mathf.Lerp(_cameraTransform.localPosition.z, _targetPosition, delta / 0.2f);
            _cameraTransform.localPosition = _cameraTransfromPosition;
        }
    }
}
